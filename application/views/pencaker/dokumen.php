                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($doc->pencakerdokumen_id != NULL) { ?>
                                                ...
                                                <a target="_blank" class="btn btn-sm btn-info btnViewDokumen" href="<?php echo base_url('uploads/pencaker/') . $doc->nopendaftaran . '/' . $doc->namadokumen; ?>" data-id="<?php ?>" data-placement="left" title="Lihat Dokumen"><i class="fas fa-eye"></i></a>&nbsp;
