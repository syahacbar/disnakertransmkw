        ...
        <div class="container">
            ...
            <div class="row content">
                ...
                <div class="col-lg-12 mt-4 mb-4">
                    <h4>Bidang Pelatihan Kerja dan Penempatan Angkatan Kerja</h4>
                    <p>
                    Bidang Pelatihan Kerja dan Penempatan Kerja mempunyai tugas:
                    </p>
                    <ul>
...
.</li>
                ...
                <div class="col-lg-12 mt-4">
                    <h4>Bidang Hubungan Industrial dan Pembinaan Ketenagakerjaan</h4>
                    <p>
                    Bidang Hubungan Industrial dan Pembinaan Ketenagakerjaan mempunyai tugas:
                    </p>
                    <ul>
...
.</li>
                ...
                <div class="col-lg-12 mt-4">
                    <h4>Pekerja Asing</h4>
                    <p>
                    Data pekerja asing tahun 2022 adalah sebagai berikut:
                    </p>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Galeri Bidang Tenaga Kerja</h2>
