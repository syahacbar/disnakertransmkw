...
<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/frontend/assets/css/detailpengumuman-custom-css.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-9 isiberita">
                    ...
                    <h2 class="text-capitalize"><?php echo $detailpengumuman->judul; ?></h2>
                    <p class="text-primary">
                        <i class="bx bxl-calendar text-secondary"></i> <?php echo longdate_indo(substr($detailpengumuman->tgl_publikasi, 0, 10));; ?>
                    </p>
                    <div class="row news-card mt-3">
                        <div class="col-sm-12 col-md-12 col-lg-12 mb-4 mt-3">
                            <div class="feed-image"><img class="news-feed-image rounded img-fluid img-responsive" src="<?php echo base_url('uploads/informasi/pengumuman/' . $detailpengumuman->gambar); ?>"></div>
                        </div>
