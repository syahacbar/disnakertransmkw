...
<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/frontend/assets/css/detailpelatihan-custom-css.css">
                ...
                <div class="col-sm-12 col-md-12 col-lg-9 isiberita">
                    ...
                    <div class="row news-card mt-3">
                        <div class="col-sm-12 col-md-12 col-lg-12 mb-4 mt-3">
                            <div class="feed-image"><img class="news-feed-image rounded img-fluid img-responsive" src="<?php echo base_url('uploads/informasi/pelatihan/' . $detailpelatihan->gambar); ?>"></div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-12 mb-3">
                            <div class="news-feed-text">
                                <?php echo $detailpelatihan->isi; ?>
                            </div>
                        </div>
